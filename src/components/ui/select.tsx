    ...
    <SelectPrimitive.Portal {...portalProps}>
      ...
      >
        ...
        >
          ...
          <div className="relative h-full min-w-(--anchor-width) rounded-lg bg-popover/80 shadow-xl/10 backdrop-blur-xl before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] dark:before:shadow-[0_-1px_--theme(--color-white/6%)]">
